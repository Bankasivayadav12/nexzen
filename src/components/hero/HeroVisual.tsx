...
export default function HeroVisual() {
  return (
    <motion.div
      ...
      className="relative w-full h-full min-h-[360px] sm:min-h-[440px] lg:min-h-[480px] xl:min-h-[520px] rounded-[28px] sm:rounded-[40px] overflow-hidden bg-transparent group flex items-center justify-center"
    >
      ...
      >
        <motion.div
          ...
          whileTap={{ scale: 0.96 }}
          className="bg-[#091F38]/90 backdrop-blur-md border border-amber-400/40 px-4 py-2.5 rounded-full shadow-2xl flex items-center gap-3 text-white text-xs sm:text-sm font-extrabold group/btn cursor-pointer transition-all hover:border-amber-300"
        >
